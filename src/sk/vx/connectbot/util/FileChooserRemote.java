/*
 * File Chooser Remote Class for VX ConnectBot
...
public class FileChooserRemote extends ListActivity {
	public final static String TAG = "ConnectBot.FileChooserRemote";
	...
	private void getDir(String dirPath, TerminalBridge bridge) {

		boolean useAutoSelection = dirPath.length() < currentPath.length();

		Integer position = lastPositions.get(parentPath);

		getDirImpl(dirPath, bridge);
	...
	private void getDirImpl(final String dirPath, TerminalBridge bridge) {
		...
		String f = currentPath;
		ArrayList<String> list = bridge.
